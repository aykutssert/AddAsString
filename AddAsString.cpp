...
//Adding two 20-digit numbers as strings
...
int main() {
    ...
    do {
        ...
        reverse(a, strlen(a));  //Reverse for firstnumber
        reverse(b, strlen(b));     //Reverse for secondnumber

        cout<<"Reverse first number: "<<a<<endl;
        cout<<"Reverse second number: "<<b<<endl;

        add(a, b, res);  ///add reversed two numbers

        reverse(res, strlen(res));   ///reversing the summed number
